package uk.co.elionline.emerge.mathematics.values.quantities;

import java.util.List;
import java.util.Map;

import uk.co.elionline.emerge.mathematics.functions.collections.ListTransformOnceView;
import uk.co.elionline.emerge.mathematics.functions.collections.UnmodifiableMapFunction;
import uk.co.elionline.emerge.mathematics.values.Fraction;
