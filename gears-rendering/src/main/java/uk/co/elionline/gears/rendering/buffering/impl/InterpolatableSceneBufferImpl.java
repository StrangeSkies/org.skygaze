...
import uk.co.elionline.gears.rendering.buffering.InterpolatableSceneBuffer;
import uk.co.elionline.gears.utilities.IdentityComparator;
import uk.co.elionline.gears.utilities.Self;

public class InterpolatableSceneBufferImpl extends SceneBufferImpl implements
		InterpolatableSceneBuffer {
	private final DoubleValue delta;

	private final TreeMap<DoubleBuffer<?, ?>, List<DoubleBuffer<?, ?>>> interpolations;

	public InterpolatableSceneBufferImpl() {
