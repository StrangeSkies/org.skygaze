package uk.co.strangeskies.extengine.swing.rendering.graphics2d.impl;
...
import uk.co.strangeskies.extengine.rendering.RendererBuffer;
...
import uk.co.strangeskies.extengine.swing.rendering.graphics2d.CircularExtensionDependencyException;
import uk.co.strangeskies.extengine.swing.rendering.graphics2d.GraphicsRenderer2DExtension;
import uk.co.strangeskies.extengine.swing.rendering.graphics2d.GraphicsRenderer2DExtensionProcessingContext;
...
public class GraphicsRenderer2D implements Renderer2D {
	protected class ExtensionProcessor<T extends Data2D> {
		...
		public ExtensionProcessor(final Graphics2D graphics,
			...
			processingContext = new GraphicsRenderer2DExtensionProcessingContext<T>() {
				...
				public T getExtensionData() {
					return renderable
							.getExtensionData(extension.getDataClass());
				}
			};
		}
