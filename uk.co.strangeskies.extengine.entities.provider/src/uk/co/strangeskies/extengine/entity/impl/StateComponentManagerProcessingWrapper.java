...
public class StateComponentManagerProcessingWrapper implements StateComponentManager {
	private final StateComponentManager component;
	private final StripedReadWriteLockRelease<StateComponent<?, ?>> locks;

	public StateComponentManagerProcessingWrapper(StateComponentManager entityStateManager,
			StripedReadWriteLockRelease<StateComponent<?, ?>> locks) {
		component = entityStateManager;
		this.locks = locks;
	}

	protected StateComponentManager getComponent() {
		return component;
	}
