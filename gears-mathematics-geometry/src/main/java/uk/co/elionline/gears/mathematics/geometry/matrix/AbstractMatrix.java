...
public abstract class AbstractMatrix<S extends Matrix<S, V>, V extends Value<V>>
	...
	private AbstractMatrix(Order order) {
		if (order == null) {
	...
	public AbstractMatrix(int rows, int columns, Order order,
	...
	public AbstractMatrix(int rows, int columns, Factory<V> valueFactory) {
		this(rows, columns, getDefaultOrder(), valueFactory);
	}

	public AbstractMatrix(Factory<V> valueFactory, Matrix<?, ?> other) {
		this(other.getOrder(), valueFactory, other.getData2());
	}

	public AbstractMatrix(Matrix<?, V> other) {
		this(other.getOrder(), other.getData2());
	}

	public <I> AbstractMatrix(int rows, int columns, Order order,
	...
	public <I> AbstractMatrix(int rows, int columns,
			List<? extends I> values,
			UnaryOperation<? extends V, ? super I> creationOperation) {
		this(rows, columns, getDefaultOrder(), values, creationOperation);
	}

	public <I> AbstractMatrix(Order order,
	...
	public <I> AbstractMatrix(List<? extends List<? extends I>> values,
			UnaryOperation<? extends V, ? super I> creationOperation) {
	...
	public AbstractMatrix(Order order, final Factory<V> valueFactory,
	...
	public AbstractMatrix(Factory<V> valueFactory,
			List<? extends List<? extends Value<?>>> values) {
	...
	public AbstractMatrix(Order order,
	...
	public AbstractMatrix(List<? extends List<? extends Value<V>>> values) {
	...
	@SafeVarargs
	public AbstractMatrix(int rows, int columns, Value<V>... values) {
		this(rows, columns, getDefaultOrder(), values);
	}
	...
	public AbstractMatrix(final boolean copyByReference, Order order,
	...
	public AbstractMatrix(boolean copyByReference,
			List<? extends List<? extends V>> values) {
		this(copyByReference, getDefaultOrder(), values);
	}

	@SafeVarargs
	public AbstractMatrix(int rows, int columns, boolean copyByReference,
	...
	public AbstractMatrix(Factory<V> valueFactory, int[]... values) {
		this(getDefaultOrder(), valueFactory, values);
	}
	...
	public AbstractMatrix(Factory<V> valueFactory, long[]... values) {
		this(getDefaultOrder(), valueFactory, values);
	}
	...
	public AbstractMatrix(Factory<V> valueFactory, float[]... values) {
		this(getDefaultOrder(), valueFactory, values);
	}
	...
	public AbstractMatrix(Factory<V> valueFactory, double[]... values) {
		this(getDefaultOrder(), valueFactory, values);
	}

	public AbstractMatrix(Order order, Factory<V> valueFactory,
			Vector<?, ?>... values) {
	...
	public AbstractMatrix(Factory<V> valueFactory, Vector<?, ?>... values) {
		this(getDefaultOrder(), valueFactory, values);
	}

	@SafeVarargs
	public AbstractMatrix(Order order, Vector<?, V>... values) {
	...
	@SafeVarargs
	public AbstractMatrix(Vector<?, V>... values) {
		this(getDefaultOrder(), values);
	}

	@SafeVarargs
	public AbstractMatrix(boolean copyByReference, Order order,
			Vector<?, V>... values) {
	...
	@SafeVarargs
	public AbstractMatrix(boolean copyByReference, Vector<?, V>... values) {
		this(copyByReference, getDefaultOrder(), values);
	}
	...
	public static void setDefaultOrder(Order defaultOrder) {
		...
		AbstractMatrix.defaultOrder = defaultOrder;
	}
