 ...
 */
public abstract class AbstractVector<S extends AbstractVector<S, V>, V extends Value<V>>
	...
	private AbstractVector(Order order, Orientation orientation) {
	...
	public AbstractVector(int size, Order order, Orientation orientation,
	...
	public AbstractVector(int size, Factory<V> valueFactory) {
		this(size, getDefaultOrder(), getDefaultOrientation(), valueFactory);
	}

	public AbstractVector(Orientation orientation, Factory<V> valueFactory,
			Matrix<?, ?> other) {
		this(other.getOrder(), orientation, valueFactory, other.getData2(), null);
	}

	public AbstractVector(Factory<V> valueFactory, Matrix<?, ?> other) {
		this(getDefaultOrientation(), valueFactory, other);
	}

	public AbstractVector(Orientation orientation, Matrix<?, V> other) {
		this(other.getOrder(), orientation, other.getData2(), (Void) null);
	}

	public AbstractVector(Matrix<?, V> other) {
		this(getDefaultOrientation(), other);
	}

	public AbstractVector(Factory<V> valueFactory, Vector<?, ?> other) {
		this(other.getOrder(), other.getOrientation(), valueFactory, other
				.getData());
	}

	public AbstractVector(Vector<?, V> other) {
		this(other.getOrder(), other.getOrientation(), other.getData());
	}

	public <I> AbstractVector(Order order, Orientation orientation,
	...
	public <I> AbstractVector(List<? extends I> values,
			UnaryOperation<? extends V, ? super I> creationOperation) {
		this(getDefaultOrder(), getDefaultOrientation(), values, creationOperation);
	}

	protected <I> AbstractVector(Order order, Orientation orientation,
	...
	protected <I> AbstractVector(List<? extends List<? extends I>> values,
			UnaryOperation<? extends V, ? super I> creationOperation, Void flag) {
		this(getDefaultOrder(), getDefaultOrientation(), values, creationOperation,
				null);
	}

	public AbstractVector(Order order, Orientation orientation,
	...
	public AbstractVector(Factory<V> valueFactory, List<? extends Value<?>> values) {
		this(getDefaultOrder(), getDefaultOrientation(), valueFactory, values);
	}

	protected AbstractVector(Order order, Orientation orientation,
	...
	protected AbstractVector(Factory<V> valueFactory,
			List<? extends List<? extends Value<?>>> values, Void flag) {
	...
	public AbstractVector(Factory<V> valueFactory, Value<?>... values) {
		this(getDefaultOrder(), getDefaultOrientation(), valueFactory, values);
	}
	...
	public AbstractVector(List<? extends Value<V>> values) {
	...
	protected AbstractVector(List<? extends List<? extends Value<V>>> values,
			Void flag) {
	...
	@SafeVarargs
	public AbstractVector(Value<V>... values) {
		this(getDefaultOrder(), getDefaultOrientation(), values);
	}

	public AbstractVector(final boolean copyByReference, Order order,
	...
	public AbstractVector(final boolean copyByReference, List<? extends V> values) {
		this(copyByReference, getDefaultOrder(), getDefaultOrientation(), values);
	}

	protected AbstractVector(final boolean copyByReference, Order order,
	...
	protected AbstractVector(final boolean copyByReference,
	...
	@SafeVarargs
	public AbstractVector(boolean copyByReference, Order order,
			Orientation orientation, V... values) {
		this(copyByReference, order, orientation, Arrays.asList(values));
	}

	@SafeVarargs
	public AbstractVector(boolean copyByReference, V... values) {
		this(copyByReference, getDefaultOrder(), getDefaultOrientation(), values);
	}
	...
	public AbstractVector(Factory<V> valueFactory, Number... values) {
		this(getDefaultOrder(), getDefaultOrientation(), valueFactory, values);
	}
	...
	public AbstractVector(Factory<V> valueFactory, int[] values) {
		this(getDefaultOrder(), getDefaultOrientation(), valueFactory, values);
	}
	...
	public AbstractVector(Factory<V> valueFactory, long[] values) {
		this(getDefaultOrder(), getDefaultOrientation(), valueFactory, values);
	}
	...
	public AbstractVector(Factory<V> valueFactory, float[] values) {
		this(getDefaultOrder(), getDefaultOrientation(), valueFactory, values);
	}
	...
	public AbstractVector(Factory<V> valueFactory, double[] values) {
		this(getDefaultOrder(), getDefaultOrientation(), valueFactory, values);
	}
	...
	public static void setDefaultOrientation(Orientation defaultOrientation) {
		AbstractVector.defaultOrientation = defaultOrientation;
	}

	public static Order getDefaultOrder() {
		return AbstractMatrix.getDefaultOrder();
	}

	public static void setDefaultOrder(Order defaultOrder) {
		AbstractMatrix.setDefaultOrder(defaultOrder);
	}
	...
	public final V getSize() {
		return getSizeSquared().squareRoot();
	}
