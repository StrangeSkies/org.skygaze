...
public interface ServiceWrapperManager extends EventListenerHook, FindHook {
	 ...
	 * 
	 * <p>
	 * Implementations of {@link ServiceWrapperManagerRetroactingImpl} may choose to not
	 ...
	 * {@link ServiceWrapperManagerRetroactingImpl} may only be able to wrap services which
